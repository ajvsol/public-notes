		  ...
		  collapsed:: true
			- Meta
				...
				- [Cheatsheet](https://www.codecademy.com/learn/learn-c-sharp/modules/csharp-hello-world/cheatsheet)
				  ![codecademy c# cheatsheet.pdf](../assets/codecademy_c#_cheatsheet_1704998904655_0.pdf)
			...
			- Syllabus
				...
				- # Data Types and Variables
					...
					- ## C# Data Types
						- [Built-in data types](https://www.codecademy.com/resources/docs/c-sharp/data-types)
					...
					- ## Creating Variables with Types
						- We can declare variables on either two lines or one line:
							...
							- One line:
							  ...
							  ```
					- ## Handling Errors
						- If you forget the specify the type:
						  ``
