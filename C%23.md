	...
	- Learning resources sorted by priority
	  id:: 64400aaf-af93-4739-a73b-97b213f053d6
		- [Learn C# | Codecademy](https://www.codecademy.com/learn/learn-c-sharp)
		  ...
		  collapsed:: true
			- Meta
				- https://discuss.codecademy.com/t/408358
				-
				- https://discuss.codecademy.com/t/faq-hello-world-what-is-c/408358
			- # Syllabus
				- # Hello World
				  collapsed:: true
				  [Cheatsheet](https://www.codecademy.com/learn/learn-c-sharp/modules/csharp-hello-world/cheatsheet) / ![codecademy c# cheatsheet.pdf](../assets/codecademy_c#_cheatsheet_1704998904655_0.pdf)
					- ## Hello World
					  collapsed:: true
						...
						- `dotnet run`
						  Execute a C# program
						- String interpolation: C# vs JavaScript
						  collapsed:: true
							- [[C#]] way:
							  ```c#
							  Console.WriteLine($"You are {input} years old!");
						...
						- Code comments, either:
						  collapsed:: true
							...
							- `/*  */`
								- ```c#
								  /* This variable will be used to count the number 
								  of times anyone tweets the word persnickety */
								  int persnicketyCount = 0;
								  ```
				  ...
				  [Cheatsheet](https://www.codecademy.com/learn/learn-c-sharp/modules/learn-csharp-module-ii/cheatsheet)
						...
						- ### C# Data Types
						  collapsed:: true
							- [Built-in data types](https://www.codecademy.com/resources/docs/c-sharp/data-types) cheatsheet
								- ![image.png](../assets/image_1705004403546_0.png)
					...
					- ## Working with Numbers
						- ### Introduction to Working with Numbers
						  collapsed:: true
							- In this lesson, we’ll look at a few of the most commonly used numerical [data types](https://www.codecademy.com/resources/docs/c-sharp/data-types) in C#. By the end of this lesson, you will be able to manipulate numerical data and write programs that perform calculations using arithmetic [operators](https://www.codecademy.com/resources/docs/c-sharp/operators) and built-in [methods](https://www.codecademy.com/resources/docs/c-sharp/methods).
